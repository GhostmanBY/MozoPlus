...
class MainWindow(QMainWindow):
    def __init__(self):  # Corregido el método de inicialización
        ...
        with open("img/background.jpg", "rb") as file:
    ...
    def buttonStyle(self):
        ...
        QPushButton:hover {
            background-color: rgba(255, 255, 0, 0.8); /* Amarillo al pasar el mouse */
        }
        QPushButton:pressed {
